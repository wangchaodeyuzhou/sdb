...
type SDBClient interface {
	...
	CInfo(ctx context.Context, in *CInfoRequest, opts ...grpc.CallOption) (*CInfoResponse, error)
}
...
func (c *sDBClient) CInfo(ctx context.Context, in *CInfoRequest, opts ...grpc.CallOption) (*CInfoResponse, error) {
	out := new(CInfoResponse)
	err := c.cc.Invoke(ctx, "/proto.SDB/CInfo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SDBServer interface {
	...
	CInfo(context.Context, *CInfoRequest) (*CInfoResponse, error)
...
func (UnimplementedSDBServer) CInfo(context.Context, *CInfoRequest) (*CInfoResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CInfo not implemented")
}
...
func _SDB_CInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CInfoRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SDBServer).CInfo(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.SDB/CInfo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SDBServer).CInfo(ctx, req.(*CInfoRequest))
	}
	return interceptor(ctx, in, info, handler)
}
